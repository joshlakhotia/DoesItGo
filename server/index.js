...
app.post("/launches", async (req, res) => {
  try {
    ...
    const newLaunchTechInfo = await pool.query(
      "INSERT INTO launch_technical_info (wind_limit, launch_direction, slope, elevation_ft, elevation_m, flyable_alt_f, flyable_alt_m) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *",
      [
        wind_limit,
        launch_direction,
        slope,
